<x-admin-layout>
    ...
    <h3 class="text-gray-700 text-3xl font-semibold">Permission</h3>
    <div class="flex justify-end m-2 p-2">
        <a href="{{route('admin.permissions.index')}}" class="px-4 py-2 bg-indigo-400 rounded">Back</a>
    </div>
    <div class="max-w-md mx-auto bg-gray-100 p-6 mt-12 rounded">
        <form method="post" action="{{route('admin.permissions.update', $permission->id)}}">
            ...
            <div class="flex justify-between items-center px-5 py-3 text-gray-700 border-b">
                <h3 class="text-sm">Add Permission</h3>
            ...
            <div class="px-5 py-6 bg-gray-200 text-gray-700 border-b">
                ...
                <div class="mt-2 relative rounded-md shadow-sm">
                    ...
                    <input type="text" name="name" value="{{$permission->name}}" class="form-input w-full px-12 py-2 appearance-none rounded-md focus:border-indigo-600">
                </div>
                @error('name')
